package com.kongrongqi.shopmall.zhy.autolayout.config;
...
import com.kongrongqi.shopmall.zhy.autolayout.utils.ScreenUtils;
...
public class AutoLayoutConifg
{
    ...
    public void init(Context context)
    {
        ...
        Logger.e("AutoLayoutConifg"," screenWidth =" + mScreenWidth + " ,screenHeight = " + mScreenHeight);
    }
    ...
    private void getMetaData(Context context)
    {
        ...
        Logger.e("AutoLayoutConifg"," designWidth =" + mDesignWidth + " , designHeight = " + mDesignHeight);
    }
