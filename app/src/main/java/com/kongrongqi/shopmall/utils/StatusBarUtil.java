        ...
        if (isHide) {
            ...
            if (Build.VERSION.SDK_INT <= Build.VERSION_CODES.KITKAT) {
                ...
                if (childCount > 0 || decorView.getChildAt(childCount - 1) instanceof StatusBarView) {
                    decorView.getChildAt(childCount - 1).setBackgroundColor(calculateStatusColor(App.getInstance().getResources().getColor(R.color.colorAccent), 0));
                }else{
                    decorView.addView(createStatusBarView(activity, App.getInstance().getResources().getColor(R.color.colorAccent), 0));
                }
                for (int i = 0; i < childCount; i++) {
