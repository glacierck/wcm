...
public class ServiceTrusteeship extends ServiceSuper {

    public ServiceTrusteeship(Context context, ServiceBean serviceBean) {
        super(context, serviceBean);
    }

    public ServiceTrusteeship(Context context, UserServiceParam userServiceParam) {
...
//        serviceBean.setDuration(serviceBean.getDuration()+serviceBean.getDurationUnit()); //服务周期
    ...
    private OrderNumRequest getOrderInfo(ServiceBean model) {
        ...
        request.setExpireDays(model.getValidDay() + "");
