 ...
 * 作者:penny
 */
public class NoUserServiceAdaper extends BaseRecycleViewAdapter{
    private final NoUserServicePresenter mPresenter;
    ...
    public NoUserServiceAdaper(NoUserServicePresenter servicePresenter, Context context) {
