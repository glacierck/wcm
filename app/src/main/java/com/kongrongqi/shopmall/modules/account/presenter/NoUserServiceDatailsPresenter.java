...
import com.kongrongqi.shopmall.modules.account.adapter.NoUserServiceAdaper2;
 ...
 * 作者:pen*/
public class NoUserServiceDatailsPresenter extends BaseLoadingPresenter<UserService,IAddServiceTabView>{
    ...
    public void setAdapter(XRecyclerView xrecyclerView, DeviceWechat deviceWechat) {
        ...
        mSuperAdapter = new NoUserServiceAdaper2(this, getContext());
...
//        });
    ...
    private void itemUseService(UserService currentCheckUserService) {
        ...
        userServiceParam.setEntrance( ServiceSuper.ACCOUNT);
