 ...
 * 作者:penny
 */
public class WorkingPresenter extends BaseLoadingPresenter<WorkingModel, IWorkingView> {

    private final RequestEmpty mRequestEmpty;
    public static final String TAG = "WorkingPresenter";

    public WorkingPresenter() {
    ...
    public void setAdapter(XRecyclerView recylerView) {
        ...
        mSuperAdapter = new WorkingAdapter(getContext(), this);
    ...
    public void stopServiceDialog(WorkingModel model) {
        ...
        try {
            ...
            StyleDialog.showRestartService(getContext(), "提示", "您即将暂停该服务，是否确定？", new StyleDialog.DialogEnterListener() {
                @Override
                public void onEnter() {
                    restartService(model,2);
                }
            });
        }catch (Exception e){
