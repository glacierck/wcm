 ...
 * 作者:penny
 */
public class ServiceAdaper2 extends BaseRecycleViewAdapter {
    public static final String TAG = "ServiceAdaper";
    private final ServiceListPresenter mPresenter;
    private final Context mContext;

    public ServiceAdaper2(ServiceListPresenter servicePresenter, Context context) {
        ...
        if (lStatus == 1) { //可以购买
            ...
            mHolder.mBuy.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    mPresenter.BuyService(position, ServiceAdaper2.this, serviceName);
                }
            });
