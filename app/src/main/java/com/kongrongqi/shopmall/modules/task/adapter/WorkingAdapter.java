 ...
 * 作者:penny
 */
public class WorkingAdapter extends BaseRecycleViewAdapter {
    private final Context mContext;
    private final WorkingPresenter mPresenter;

    public WorkingAdapter(Context context, WorkingPresenter presenter) {
...
//                addFried(mHolder, model.getTodayFansNum(), model.getFansNum());
    ...
    private void goneAddfried(WorkingHolder mHolder, WorkingModel model) {
        ...
        if(TextUtils.isEmpty(model.getMsg())){
            mHolder.bt_right_restart.setText("暂停服务");
