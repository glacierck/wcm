...
package com.kongrongqi.shopmall.wedget.materialspinner;
...
public class MaterialSpinner extends TextView {
  ...
  private void init(Context context, AttributeSet attrs) {
    ...
    setBackgroundResource(R.drawable.shape_dialog_bj);
  ...
  /**
   * Register a callback to be invoked when the {@link PopupWindow} is shown but the use didn't select an item.
   *
