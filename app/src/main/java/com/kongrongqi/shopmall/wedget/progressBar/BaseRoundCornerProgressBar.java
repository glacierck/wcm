...
public abstract class BaseRoundCornerProgressBar extends LinearLayout {
    ...
    protected final static int DEFAULT_PROGRESS_RADIUS = 15;
    ...
    protected abstract void drawProgress(LinearLayout layoutProgress, float max, float progress, float totalWidth,
                                         float totalHight, int radius, int padding, int colorProgress, boolean isReverse);
    ...
    private void drawPrimaryProgress() {
        drawProgress(layoutProgress, max, progress, totalWidth, mNewHeight, radius, padding, colorProgress, isReverse);
    }

    private void drawSecondaryProgress() {
        drawProgress(layoutSecondaryProgress, max, secondaryProgress, totalWidth, mNewHeight,radius, padding, colorSecondaryProgress, isReverse);
    }
    ...
    private void setupReverse(LinearLayout layoutProgress) {
        ...
        if (isReverse) {
            ...
            // For support with RTL on APIDebug 17 or more
