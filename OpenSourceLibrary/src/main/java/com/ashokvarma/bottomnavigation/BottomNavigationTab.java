...
class BottomNavigationTab extends FrameLayout {
    ...
    public void setIconLayoutGravityCenter() {
        ...
        MarginLayoutParams llp = (MarginLayoutParams) shapeBadgeView.getLayoutParams();
        llp.topMargin = Utils.dp2px(getContext(), 10);
        shapeBadgeView.setLayoutParams(llp);

        MarginLayoutParams lp = (MarginLayoutParams) textBadgeView.getLayoutParams();
    ...
    public void select(boolean setActiveColor, int animationDuration) {
        ...
        if (labelView.getVisibility() != GONE) {
            ValueAnimator animator = ValueAnimator.ofInt(containerView.getPaddingTop(), paddingTopActive + 10, paddingTopActive + 10, containerView.getPaddingTop());
