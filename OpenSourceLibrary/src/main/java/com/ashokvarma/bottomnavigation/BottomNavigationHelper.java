    ...
    private static void setShapeBadgeForTab(ShapeBadgeItem shapeBadgeItem, BottomNavigationTab bottomNavigationTab) {
        if(shapeBadgeItem != null){
            ...
            if( shapeBadgeItem.getShape() == ShapeBadgeItem.CIRCLE ){
                bottomNavigationTab.shapeBadgeView.setBackgroundDrawable( context.getResources().getDrawable(com.uxin.opensource.R.drawable.shape_circle) );
            }else if( shapeBadgeItem.getShape() == ShapeBadgeItem.SQUARE){
                bottomNavigationTab.shapeBadgeView.setBackgroundDrawable( context.getResources().getDrawable(com.uxin.opensource.R.drawable.shape_rect) );
            }else{
